...
function setup_testing_input_output {
  ...
  #echo "checkpoint: ${PROJECT_PATH}/output"
  #ls ${PROJECT_PATH}/output
  #echo "checkpoint: ${TEST_OUTPUT_PATH}/output"
  #ls ${TEST_OUTPUT_PATH}/output

  rm -r ${TEST_OUTPUT_PATH}/input/*
  rm -f ${TEST_OUTPUT_PATH}/output/*
